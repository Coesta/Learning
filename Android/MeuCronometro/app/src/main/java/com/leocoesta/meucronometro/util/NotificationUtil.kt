...
import com.leocoesta.meucronometro.MainActivity
...
class NotificationUtil {
    companion object {
        ...
        fun showTimerExpired(context: Context) {
            ...
            notificationBuilder.setContentTitle("Tempo Expirado!")
                .setContentText("Começar novamente?")
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .addAction(R.drawable.ic_start, "Começar", startPendingIntent)
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long) {
            ...
            val notificationBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            notificationBuilder.setContentTitle("Cronômetro em Execução!")
                .setContentText("Termina: ${dateFormat.format(Date(wakeUpTime))}")
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
        ...
        fun showTimerPaused(context: Context) {
            ...
            val notificationBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            notificationBuilder.setContentTitle("Cronômetro Pausado!")
                .setContentText("Continuar?")
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.ic_start, "Continuar", resumePendingIntent)
